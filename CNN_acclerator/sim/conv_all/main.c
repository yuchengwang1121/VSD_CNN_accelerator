...
/* EPU data address */
  ...
  /* Conv2 */
    // w2 data address
    extern unsigned int __w2_conv2_start;
    extern unsigned int __w2_conv2_end;
    extern unsigned int __w2_conv2_data_in_dram_start;
    // bias data address
    extern unsigned int __bias_conv2_start;
    extern unsigned int __bias_conv2_end;
    extern unsigned int __bias_conv2_data_in_dram_start;
    // param data address 
    extern unsigned int __param_conv2_start;
    extern unsigned int __param_conv2_end;
    extern unsigned int __param_conv2_data_in_dram_start;
  /* Pool0 */
    // param data address 
...
/* conv2 */
  // Move param data
  quantity = (&__param_conv2_end - &__param_conv2_start) - 1;
  dma_move(&__param_conv2_data_in_dram_start, &__param_conv0_start, quantity);
  // Move w2 data
  quantity = (&__w2_conv2_end - &__w2_conv2_start) - 1;
  dma_move(&__w2_conv2_data_in_dram_start, &__w2_conv0_start, quantity);
  // Move bias data
  quantity = (&__bias_conv2_end - &__bias_conv2_start) - 1;
  dma_move(&__bias_conv2_data_in_dram_start, &__bias_conv0_start, quantity);
